...
class QuickBooksAutoSyncManager: ObservableObject {
    ...
    enum SyncStatus {
        case idle
        case syncing
        case success(customersCount: Int, invoicesCount: Int)
        ...
        var description: String {
            ...
            case .syncing:
                return "Syncing..."
            case .success(let customers, let invoices):
                return "Synced \(customers) customers, \(invoices) invoices"
    ...
    private func performSync() async {
        ...
        do {
            ...
            lastSyncStatus = .success(customersCount: customersCount, invoicesCount: invoicesCount)
