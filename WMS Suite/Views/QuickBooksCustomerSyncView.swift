...
struct QuickBooksCustomerSyncView: View {
    ...
    var body: some View {
        NavigationView {
            ...
            .navigationTitle("QuickBooks Customer Sync")
    ...
    private var syncButtonSection: some View {
        VStack(spacing: 12) {
            Button(action: {
                ...
                HStack {
                    Image(systemName: "arrow.triangle.2.circlepath")
                        .font(.title3)
                    Text("Sync Customers from QuickBooks")
                        .font(.headline)
                }
            ...
            Text("This will import all customers from QuickBooks Online")
                .font(.caption)
                .foregroundColor(.secondary)
    ...
    private func startCustomerSync() async {
        ...
        do {
            ...
            try await service.syncCustomers(context: viewContext) { message in
                Task { @MainActor in
                    addLog(message)
            ...
            await MainActor.run {
                ...
                addLog("✅ Customer sync completed successfully!")
            }
...
struct QuickBooksCustomerSyncView_Previews: PreviewProvider {
